...
func (m *BookResult) Converter(sessionId string) (ConvertBookResult, error) {
	...
	ebookConfig := converter.Config{
		...
		Footer:       "\"<p style='color:#8E8E8E;font-size:12px;'>本文档使用 <a href='https://mindoc.com.cn' style='text-decoration:none;color:#1abc9c;font-weight:bold;'>MinDoc</a> 构建 <span style='float:right'>- _PAGENUM_ -</span></p>\"",
